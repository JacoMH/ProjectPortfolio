<x-contact>
    <section class='container flex flex-col justify-center m-auto p-5 h-screen pt-20 pb-20 sm:pt-0 sm:pb-0 overflow-y-auto'>
            ...
            <div class="p-6 text-gray-900 flex flex-wrap justify-center items-center">
                ...
                <div class='max-w-[350px] m-5 rounded-lg shadow-lg ring-4 ring-blue-500 ring-opacity-50 ring-offset-2 ring-offset-blue-200 hover:ring-opacity-100 hover:ring-offset-4 hover:scale-105 transition-all duration-300 ease-in-out'>
                    ...
                    <a href="https://github.com/JacoMH" target='_blank' rel="noreferrer noopener">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="80" height="80" viewBox="0,0,256,256">
                            <g fill="#3f81f5" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter">
                ...
                <div class='max-w-[350px] m-5 rounded-lg shadow-lg ring-4 ring-blue-500 ring-opacity-50 ring-offset-2 ring-offset-blue-200 hover:ring-opacity-100 hover:ring-offset-4 hover:scale-105 transition-all duration-300 ease-in-out'>
                    ...
                    <a href="mailto:heyesjacob@gmail.com">
                        <svg xmlns="http://www.w3.org/2000/svg" class='p-3' width="80" height="80" viewBox="0 0 128 96" id="Email">
